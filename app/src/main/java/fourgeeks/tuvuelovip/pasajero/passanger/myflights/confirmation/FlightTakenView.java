...
public class FlightTakenView extends Fragment {
    public static final String TAG = FlightTakenView.class.getSimpleName();
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.flight_taken_view, container, false);
    ...
    private void save(final FragmentActivity activity) {
        ...
        controller.rateFlight(flightId, ratingBar.getNumStars(), reviewText.getText().toString()).subscribe(new SingleSubscriber<Void>() {
            @Override
            ...
            public void onError(Throwable error) {
                progressBar.setVisibility(View.GONE);
                String msg = Util.msgFromRetrofitThrowable(FlightTakenView.this, error);
